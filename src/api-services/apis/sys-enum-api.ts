...
export const SysEnumApiFp = function (configuration?: Configuration) {
	return {
		 ...
		 * @throws {RequiredError}
		 */
		async apiSysEnumEnumDataListByFieldGet(
			entityName: string,
			fieldName: string,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultListEnumEntity>>> {
	...
	return {
		...
		async apiSysEnumEnumDataListByFieldGet(entityName: string, fieldName: string, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultListEnumEntity>> {
			return SysEnumApiFp(configuration)
				.apiSysEnumEnumDataListByFieldGet(entityName, fieldName, options)
